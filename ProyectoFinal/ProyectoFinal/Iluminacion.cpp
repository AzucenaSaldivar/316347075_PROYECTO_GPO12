...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       /* glDrawArrays(GL_TRIANGLES, 0, 36);*/
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.235f, 0.925f, 0.635f);
       ...
       // model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.968f, 0.792f, 0.650f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.972f, 0.349f, 0.662f);
